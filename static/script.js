...
class table1 {
    ...
    static row1() {
        ...
        // Set badge source
        base.setBadgeSource(`https://img.shields.io/badge/endpoint.svg?url=https%3A%2F%2F${hostname}%2Fis-it%2F${days[d.getDay()]}`);
    ...
    static row2() {
        ...
        // Set badge source
        base.setBadgeSource(`https://img.shields.io/badge/endpoint.svg?url=https%3A%2F%2F${hostname}%2Fis-it%2F${days[tomorrow.getDay()]}`);
    ...
    static row3() {
        ...
        // Set badge source
        base.setBadgeSource(`https://img.shields.io/badge/endpoint.svg?url=https%3A%2F%2F${hostname}%2Fis-it%2Finvalid`);
    }
}
...
class debugTable {
    ...
    static row1() {
        ...
        base.setBadgeSource(`https://img.shields.io/badge/endpoint.svg?url=https%3A%2F%2F${hostname}%2Fdebug%2Froutes%2Fformatted`);
    }
    ...
    static row2() {
        ...
        // Set badge source relative to hostname
        base.setBadgeSource(`https://img.shields.io/badge/endpoint.svg?url=https%3A%2F%2F${hostname}%2Fdebug%2Fdatetime%2Fformatted`);
    }
}